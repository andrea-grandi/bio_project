...
from bio_project import config
from bio_project.models.predict import predict
from bio_project.response_handler import APIResponseHandler

ALLOWED_EXTENSIONS = {'png', 'jpg', 'jpeg', 'pdf', 'xlsx'}

app = Flask('bio_project')
app.config['UPLOAD_FOLDER'] = config.DATA_FOLDER
router = '/bio_project/' + config.ENV
