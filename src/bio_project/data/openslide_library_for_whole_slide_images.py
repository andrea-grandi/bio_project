...
import os
tile_dir = "/Users/andreagrandi/Developer/bio_project/src/bio_project/data/images/saved_tiles/original_tiles/"
for row in range(rows):
    for col in range(cols):
        ...
        tiff.imwrite(tile_name + "_original" + ".tif", temp_tile_np)
